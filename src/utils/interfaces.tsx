...
export interface ContextType extends GameBetLimit, UserStatusType, GameStatusType {
    ...
    adminCrashOverride?: number | null;
    setAdminCrashOverride?: React.Dispatch<React.SetStateAction<number | null>>;
    isOverridePersistent?: boolean;
    setIsOverridePersistent?: React.Dispatch<React.SetStateAction<boolean>>;
}
